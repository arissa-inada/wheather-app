...
search.addEventListener('click', () => {
    ...
    const APIKey = '9ac113f93cc6407094f71130261802'; // coloque sua key da WeatherAPI
    ...
    fetch(`https://api.weatherapi.com/v1/current.json?key=${APIKey}&q=${city}&lang=pt`)
        ...
        .then(json => {
            ...
            if (condition.includes('Sol') || condition.includes('Clear')) {
                image.src = 'clear.png';
            } else if (condition.includes('Chuva') || condition.includes('Rain')) {
                image.src = 'rain.png';
            } else if (condition.includes('Neve')) {
                image.src = 'snow.png';
            } else if (condition.includes('Nublado') || condition.includes('Cloud')) {
                image.src = 'cloud.png';
            } else if (condition.includes('Névoa') || condition.includes('Mist')) {
                image.src = 'mist.png';
            } else {
                image.src = 'cloud.png';
            }
